...
class GruposControllerTest < ActionController::TestCase
  ...
  test "should create grupo" do
    assert_difference('Grupo.count') do
      post :create, grupo: { meio_transporte_id: @grupo.meio_transporte_id, nome: @grupo.nome, trajeto_grupo_id: @grupo.trajeto_grupo_id, user_id: @grupo.user_id }
    end
  ...
  test "should update grupo" do
    put :update, id: @grupo, grupo: { meio_transporte_id: @grupo.meio_transporte_id, nome: @grupo.nome, trajeto_grupo_id: @grupo.trajeto_grupo_id, user_id: @grupo.user_id }
    assert_redirected_to grupo_path(assigns(:grupo))
  end
