...
class EmpresasControllerTest < ActionController::TestCase
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post :create, :empresa => { :codigo_id => @empresa.codigo_id, :logo => @empresa.logo, :nome => @empresa.nome, :user_id => @empresa.user_id }
    end
  ...
  test "should update empresa" do
    put :update, :id => @empresa, :empresa => { :codigo_id => @empresa.codigo_id, :logo => @empresa.logo, :nome => @empresa.nome, :user_id => @empresa.user_id }
    assert_redirected_to empresa_path(assigns(:empresa))
  end
